...
export default function About() {
	...
	return (
		<Container>
			<h3>About Persian Cuisine</h3>
			<br />

			<button onClick={handleToggle} disabled={toggleText}>
				History
			</button>
			<button onClick={handleToggle} disabled={!toggleText}>
				Food of Iran
			...
			{toggleText ? (
				<>
					<p>
						...
						series of peoples has invaded and conquered the region, exposing the
						area to new customs, beliefs, ideas, and foods, as well as bringing
						Iranian customs and foods back to their own home countries. The
						ancient Babylonians, Assyrians, Persians, Greeks, Romans, and Turks
						are just a few of the groups that have had an influence on Iranian
						culture and its cuisine. Iranian cuisine is often referred to as
						"Persian." This is because, until 1934, Iran was known as Persia.
					...
					<p>
						...
						of medicine (See Mealtime Customs ). Dishes made of lamb, dates, and
						figs were brought into the Persian diet during the Arab invasion of
						the 600s. Three hundred years later, the Turks expanded their
						Ottoman Empire into Persian territory. The idea of stuffing leaves,
						vines, fruits, and vegetables with various fillings (Turkish dolma )
						was reinforced by the Turks. Dolma and kofte (meatballs) have become
						very popular throughout the Middle Eastern countries. The kebab
						(cubes of skewered meat) is probably the most important introduction
						by the Turks—it has become one of Iran's national dishes. Strong
						Turkish coffee was also introduced. Once a widely consumed Iranian
						beverage, it has now fallen behind the popularity of chây (tea). The
						strong, dark tea is brewed in an urn called a samovar , a Russian
						word. Tea most likely originated in Russia. Read more{' '}
				...
				<>
					{' '}
					<p>
						Iranian food (also referred to as Persian food) is some of the most
						delicious and fresh in its region. It is also quite healthy, using
						only small amounts of red meat (usually Chây (tea), the favorite
						beverage in Iran, is brewed in a large, ornate pot called a samovar.
						Cory Langley Chây (tea), the favorite beverage in Iran, is brewed in
						a large, ornate pot called a samovar. Cory Langley lamb or beef),
						emphasizing larger amounts of grains (especially rice), fruits, and
						vegetables. Although it is often lumped under the category of
						general "Middle Eastern" fare, the Iranian cuisine is able to retain
						its uniqueness in a variety of ways. One of these ways is preparing
						meals with contrasting flavors, such as a combination of sweet and
						sour or mild and spicy. The country's cuisine is largely based on
						berenj (rice). It is relatively inexpensive and grown locally,
						making it an affordable and readily available staple in the everyday
						diet. A typical Iranian meal is often a heaping plate of chelo
						(CHEH-loh; plain, cooked rice) topped with vegetables, fish, or
						meat. It also provides a cool contrast to spicy meat toppings. The
						two national rice dishes are chelo and polo (POH-loh; rice cooked
						with several ingredients). There are seemingly endless varieties of
						dishes that can be prepared with rice in Iran. Nân (bread), a round,
						flat bread that can either be baked or cooked over a bed of small
